...
```
    yarn add @imonk777/react-native-orientation-locker
```
...
```
    yarn add @imonk777/react-native-orientation-locker
    react-native link @imonk777/react-native-orientation-locker
```
#### Manual linking
...
import { OrientationLocker, PORTRAIT, LANDSCAPE } from "@imonk777/react-native-orientation-locker";
